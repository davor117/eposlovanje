...
<header class="header">
   ...
   <a class="logo"><img src="img/paliclogo.png" alt="logo"></a>
   </div>
        <div class="col-md-12 text-center">
            <button type="button" onclick="window.location.href='reservation.php'" class="btn btn-outline-light btn-lg"><em>Klik za rezervaciju!</em></button>
        </div>
    </div>
</header>
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Restoran Palić</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<h4 class="text-center">Naša priča</h4>
	<p><br>U sklopu etno parka Palićkog restorana nalazi se restoran domaće kuhinje i prenoćište sa 15 komfornih soba, otvorenim bazenom,
        ...
        Za sladokusce smo obezbedili fanke, domaće štrudle, gomboce, kompote…. To je samo deo bogate ponude "Palićkog restorana“.
...
<div class id="gallery"><br>
    <div class="container">
    <h3 class="text-center"><br>Galerija<br><br></h3>
...
<div class="container" id="reservation">
    <h3 class="text-center"><br><br>Rezervacije<br><br></h3>
    <img  src="img/nesto.png" class="img-fluid rounded">
    <button type="button" onclick="window.location.href='reservation.php'" class="btn btn-outline-dark btn-block btn-lg">Rezervišite odmah!</button>
