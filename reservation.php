...
if(isset($_SESSION['user_id'])){
    echo '<p class="text-white bg-dark text-center">Dobrodošao '. $_SESSION['username'] .', napravi svoju rezervaciju ovde</p>';
  ...
  //error handling:
    ...
    <div class="signup-form">
        <form action="includes/reservation.inc.php" method="post">
            ...
            <label>Ime</label>
                <input type="text" class="form-control" name="fname" placeholder="Ime" required="required">
                <small class="form-text text-muted">Ime mora biti od 2-20 karaktera</small>
            </div>
            <div class="form-group">
            <label>Prezime</label>
                <input type="text" class="form-control" name="lname" placeholder="Prezime" required="required">
                <small class="form-text text-muted">Prezime mora biti od 2-20 karaktera</small>
            </div>   
            <div class="form-group">
            <label>Unesi datum rezervacije</label>
        	<input type="date" class="form-control" name="date" placeholder="Date" required="required">
            </div>
            <div class="form-group">
		<label>Unesi vreme rezervacije</label>
		...
		<option>20:00 - 00:00</option>
            ...
            <div class="form-group">
            <label>Unesi broj gostiju</label>
        	<input type="number" class="form-control" min="1" name="num_guests" placeholder="Gosti" required="required">
                <small class="form-text text-muted">Minimum 1</small>
            </div>
            <div class="form-group">
            <label for="guests">Unesite Vaš broj</label>
                <input type="telephone" class="form-control" name="tele" placeholder="Vaš broj" required="required">
                <small class="form-text text-muted">Broj mora biti od 6-20 karaktera</small>
            </div>
            <div class="form-group">
            <label>Dodajte komentar</label>
                <textarea class="form-control" name="comments" placeholder="Komentar napišite ovde..." rows="3"></textarea>
                <small class="form-text text-muted">Comments must be less than 200 characters</small>
            </div>        
            <div class="form-group">
		<label class="checkbox-inline"><input type="checkbox" required="required"> Prihvatam <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            </div>
            <div class="form-group">
            <button type="submit" name="reserv-submit" class="btn btn-dark btn-lg btn-block">Prosledi rezervaciju</button>
            </div>
