...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Restoran Palić</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reservation.php" >Nova rezervacija</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservations.php" >Pregled rezervacija</a>
                    </li>';
	            ...
	            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#reservation">Rezervacija</a>
                    </li>     
                    '; } 
                    ?>
                    ...
                    <button type="submit" name="logout-submit" class="btn btn-outline-dark">Izloguj se</button>
                    </form>';
                    }
                    else{  
                    echo '
          ...
          <div class="modal-content">
            ...
            ?>  
                    ...
                    <form action="includes/login.inc.php" method="post">
                        <p class="hint-text">Ako već imate nalog, ulogujte se!</p>
                    <div class="form-group">
                        <input type="text" class="form-control" name="mailuid" placeholder="Korisničko ime" required="required">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="pwd" placeholder="Lozinka" required="required">
                    </div>
                    <div class="form-group">
                        <button type="submit" name="login-submit" class="btn btn-dark btn-lg btn-block">Uloguj se!</button>
                    </div>
                            </form>
                    </div>   
                </div>
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            <p class="hint-text">Kreiraj nalog. Besplatno je!</p>
                            <div class="form-group">
                                    <input type="text" class="form-control" name="uid" placeholder="Korisničko ime" required="required">
                                    <small class="form-text text-muted">Korisničko ime mora biti of 4-20 karaktera dugačko</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="pwd" placeholder="Lozinka" required="required">
                                <small class="form-text text-muted">Lozinka mora biti od 6-20 karaktera dugačka</small>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="pwd-repeat" placeholder="Potvrdi lozinku" required="required">
                            </div>        
                            <div class="form-group">
                                <label class="checkbox-inline"><input type="checkbox" required="required"> Slažem se sa <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
                            </div>
                            <div class="form-group">
                                <button type="submit" name="signup-submit" class="btn btn-dark btn-lg btn-block">Registruj se!</button>
                            </div>
                        </form>
