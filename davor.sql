...
--
-- Host: 192.168.30.23
-- Generation Time: Feb 03, 2023 at 05:52 PM
...
CREATE TABLE `korisnik` (
  ...
  `number` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `pwd` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_activation_code` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `email_status` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(96, 'Davor', 'Abadzic', 'davorabadzic@gmail.com', '555333', '$2y$10$sZaf5JC39srfHPo5RYdgT.Ht5aVRws7EHy.vnSqcs8zZUDcCflh3e', '', 'verified');
...
CREATE TABLE `pwdreset` (
  ...
  `pwdResetExperis` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `radnikprovera` (
  ...
  `kodd` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `rezervacija` (
  ...
  `kod` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `idS` int(11) NOT NULL,
  `uk` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `rezervacija`
  ...
  ADD CONSTRAINT `rezervacijaS` FOREIGN KEY (`idS`) REFERENCES `sto` (`id`) ON UPDATE CASCADE;
